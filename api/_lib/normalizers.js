...
function extractApiSportsGames(payload) {
  return toArray(payload?.response)
    .map((entry) => {
      ...
      return {
        ...
        status,
        home: normalizeTeam(teams.home || {}, { record: firstDefined(teams.home?.record, null) }),
        away: normalizeTeam(teams.away || {}, { record: firstDefined(teams.away?.record, null) }),
